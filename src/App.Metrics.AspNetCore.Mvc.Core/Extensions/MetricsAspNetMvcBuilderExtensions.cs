// <copyright file="MetricsAspNetMvcBuilderExtensions.cs" company="Allan Hardy">
// Copyright (c) Allan Hardy. All rights reserved.
// </copyright>

using System;
using App.Metrics.AspNetCore.Mvc.Core;
    ...
    // ReSharper restore CheckNamespace
{
    public static class MetricsAspNetMvcBuilderExtensions
    {
        ...
        /// </exception>
        public static IMvcCoreBuilder AddMetricsCore(this IMvcCoreBuilder mvcBuilder)
        {
            if (mvcBuilder == null)
            {
            ...
            mvcBuilder.Services.TryAddEnumerable(ServiceDescriptor.Singleton<IConfigureOptions<MvcOptions>, MetricsMvcCoreOptionsSetup>());
